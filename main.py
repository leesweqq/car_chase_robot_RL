...
def train_algo():
    ...
    checkpoint_callback = CheckpointCallback(save_freq=500000, save_path="./models", name_prefix=f"car_robot_{algo_name.lower()}")

    # Train the model for a total of 500,000 timesteps and save checkpoints
    model.learn(total_timesteps=500000, callback=checkpoint_callback)

    # Save the trained model
    model.save(f"car_robot_{algo_name.lower()}")
...
def test_algo():
    ...
    model = model.load(f"car_robot_{algo_name.lower()}")
